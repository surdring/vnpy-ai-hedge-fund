...
class MainEngine:
    ...
    def add_ai_agent(self, agent_class: type[BaseApp]) -> BaseEngine:
        """
        Register an AI Agent strategy.

        This is a semantic alias for add_app() specifically for AI Agent
        strategies. It provides a more intuitive API for registering AI-powered
        trading agents.
        """
        return self.add_app(agent_class)
